...
const PATHS = [
  { to: "/assistant/main/classes/posts", label: "Forum" },
  { to: "/assistant/main/classes/assignments", label: "Tugas Kelas" },
  { to: "/assistant/main/classes/quiz", label: "Kuis" },
  { to: "/assistant/main/classes/members", label: "Anggota" },
];
...
const AssistantClassNavbar = () => {
  return (
    <Navbar bg="dark" variant="dark" expand="lg">
      <Container xs={4} md={4}>
        <Link to="/assistant/main/classes"
            style={{textDecoration: 'none'}}>
          <Navbar.Brand
            style={{fontSize: "35px", fontWeight: 600}}>
          Kembali</Navbar.Brand>
        </Link>
